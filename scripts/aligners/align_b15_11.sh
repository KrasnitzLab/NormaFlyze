...
#$ -pe threads 2 
#$ -l vf=8G 
#$ -o /mnt/wigclust1/data/safe/kostic/output/b15_11.out -j y 
...
$BOWTIE_PATH/bowtie -q -S -t -n 2 -e 200 --chunkmbs 256 -3 0 -5 16 -m 1 -X 800 --allow-contain --best --strata hybrid_index -1 s_1_1_sequence.b11.txt -2 s_1_2_sequence.b11.txt $RESULTS_PATH/aligned_b15_11.sam
