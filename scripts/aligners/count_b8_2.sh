...
#$ -pe threads 1 
#$ -l vf=8G 
#$ -o /mnt/wigclust1/data/safe/kostic/output/count_b8_2.out -j y 
...
cd $DATA_PATH 
python $PYTHON_PATH/count_and_dedup.py <($SAM_PATH/samtools view b8_2_tagged.bam) b8_2_varbin_count.txt b8_2_varbin_stats.txt
