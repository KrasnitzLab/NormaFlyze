...
#$ -pe threads 1 
#$ -l vf=8G 
#$ -o /mnt/wigclust1/data/safe/kostic/output/count_b4_8.out -j y 
...
cd $DATA_PATH 
python $PYTHON_PATH/count_and_dedup.py <($SAM_PATH/samtools view b4_8_tagged.bam) b4_8_varbin_count.txt b4_8_varbin_stats.txt
