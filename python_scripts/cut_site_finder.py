...
#output: a text file formatted like a FASTQ output
#line 1: header
#line 2: read of length (argv[3]) 
#line 3: +
#line 4: BBB...
#for each read
...
def main():
	...
	site = sys.argv[3]
	outfile = str(site) + "_fragments_" + str(length) + "bp_6_28_fastq.fq"
	length_file = "lengths_2.txt"
	f = open(outfile, "w+")
